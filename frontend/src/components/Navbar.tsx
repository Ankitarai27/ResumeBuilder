...
const Navbar = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 px-3 sm:px-6 py-3 sm:py-4">
      <div className="max-w-7xl mx-auto glass flex flex-col sm:flex-row sm:items-center justify-between px-4 sm:px-8 py-3 gap-3 bg-white/10 border-white/20">
        ...
        <div className="flex items-center flex-wrap sm:flex-nowrap gap-2 sm:gap-4 font-medium text-slate-600 w-full sm:w-auto justify-start sm:justify-end">
          {user ? (
            <>
              {user.role === 'ADMIN' && (
